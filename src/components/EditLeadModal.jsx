...
const EditLeadModal = ({ lead, employees, userRole, onClose, onSave }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (userRole === 'admin' && submitData.assigned_to) {
        const { assigned_to, ...updateData } = submitData;
        await api.put(`/api/leads/${lead._id}`, updateData);
        
        if (assigned_to !== (lead.assigned_to?._id || '')) {
          await api.put(`/api/admin/leads/${lead._id}/assign`, {
